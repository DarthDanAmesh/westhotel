		...
		<section class="our_room">
			<div class="container"> 
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="col-md-6">
							<div class="restaurant" data-aos="fade-down" data-aos-delay="300"  style="background: url(img/restaurant_1/david-straight-341873-unsplash.jpg) no-repeat;background-size: cover;background-position: center;">
								<div class="overlay animated fadeInUp">
									<div class="desc">
										...
										<p class="text-center">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maxime sequi culpa, esse sunt odio ea veniam reprehenderit veritatis itaque sapiente? Quisquam repellat distinctio voluptatibus nulla omnis sit reiciendis error quo.</p>
										<a href="#" >Read more</a>
									</div>
								</div>
								...
								<div class="resMenu resMenu1">
									...
									<i class="fa fa-glass fa-lg ico1"></i>
						...
						<div class="col-md-6">
							<div class="restaurant" data-aos="fade-left" data-aos-delay="300" style="background: url(img/restaurant_1/pablo-merchan-montes-772142-unsplash.jpg) no-repeat;background-size: cover">
								<div class="overlay animated fadeInUp">
									<div class="desc">
					...
					<div class="col-md-12">
						<div class="col-md-6">
							<div class="restaurant" data-aos="fade-right" data-aos-delay="300" style="background: url(img/restaurant_1/5bf7e27dd7fce.png) no-repeat;background-size: cover;background-position: center;">
								<div class="overlay animated fadeInUp">
									<div class="desc">
						...
						<div class="col-md-6">
							<div class="restaurant res" data-aos="fade-up" data-aos-delay="300" style="background: url(img/restaurant_1/691383403.png) no-repeat; background-size: cover;">
								<div class="overlay animated fadeInUp">
									<div class="desc">
								...
								<div class="resMenu resMenu4">
									...
									<i class="fa fa-cutlery fa-lg ico4"></i>
					...
					<form action="" class="form_btn text-center" >
						<button ><i class="fa fa-cutlery fa-lg"></i>   Book your table</button>
					</form>
		</section>
